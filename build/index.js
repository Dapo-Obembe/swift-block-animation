...
function addAnimationAttribute(settings, name) {
  // Only apply to core blocks (skip custom if needed)
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.addFilter)("blocks.registerBlockType", "custom/extend-core-blocks/add-animate-attribute", addAnimationAttribute);

// Add UI to Inspector panel
const withAnimationControl = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.createHigherOrderComponent)(BlockEdit => {
  return props => {
    const {
      attributes,
      setAttributes,
    ...
    if (!name.startsWith("core/")) return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(BlockEdit, {
      ...props
    });
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.addFilter)("editor.BlockEdit", "custom/extend-core-blocks/with-animation-control", withAnimationControl);

// Apply attribute to save output
function applyDataAnimateProp(extraProps, blockType, attributes) {
  if (!blockType.name.startsWith("core/")) return extraProps;
  if (attributes.dataAnimate) {
    extraProps["data-animate"] = attributes.dataAnimate;
  }
  return extraProps;
}
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.addFilter)("blocks.getSaveContent.extraProps", "custom/extend-core-blocks/apply-data-animate", applyDataAnimateProp);
